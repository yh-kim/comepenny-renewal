...
public class MyInfoLikeFragement extends MyInfoBaseFragment {
    public static Fragment newInstance() {
        Bundle args = new Bundle();

        MyInfoLikeFragement fragment = new MyInfoLikeFragement();
    ...
    protected void getIdeaList() {
        new IdeaService().getIdeaListByLike(userId, offset)
